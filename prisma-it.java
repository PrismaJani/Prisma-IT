...
public class ProjektiServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Lue ympäristömuuttujat Azure-asetuksille
        String azureStorageAccountName = System.getenv("AZURE_STORAGE_ACCOUNT_NAME");
        String azureStorageAccountKey = System.getenv("AZURE_STORAGE_ACCOUNT_KEY");
